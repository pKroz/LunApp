				...
				<div class="col-6 pe-2">
					<a href="actividad.php?id=<?php echo $dataActividad1['id']; ?>" data-menu="menu-reserve" class="card card-style mx-0 mb-3">
						...
						<div class="p-2">
							...
							<h5 class="font-12 mb-0">S/. <?php echo $dataActividad1['precio']; ?><span class="float-end font-400 font-11 color-green-dark"><i class="fa fa-clock pe-1"></i><?php echo $dataActividad1['tiempo']; ?></span></h5>
						</div>
