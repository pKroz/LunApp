                        ...
                        <div class="row mb-0">
                            ...
                            <div class="col-5">
                                <a class="card mx-0 mb-2 card-style external-link" data-card-height="130"
                                    data-gallery="gallery-b" href="images/media/<?php echo $dataActividad['id']; ?>_img3.jpg"
                                    style="background-image: url(&quot;images/media/<?php echo $dataActividad['id']; ?>_img3.jpg&quot;); height: 130px;"></a>
                                <a class="card mx-0 mb-2 card-style external-link" data-card-height="130"
                                    data-gallery="gallery-b" href="images/media/<?php echo $dataActividad['id']; ?>_img4.jpg"
